package com.geo.coupon.template.service;
...
import com.geo.coupon.template.converter.CouponTemplateConverter;
import com.geo.coupon.template.dao.CouponTemplateDao;
import com.geo.coupon.template.dao.entity.CouponTemplate;
...
public class CouponTemplateServiceImpl implements CouponTemplateService {
    ...
    public List<CouponTemplateInfo> searchTemplate(CouponTemplateInfo request) {
        com.geo.coupon.template.dao.entity.CouponTemplate example = com.geo.coupon.template.dao.entity.CouponTemplate.builder()
                .shopId(request.getShopId())
                .category(CouponType.convert(request.getType()))
                .available(request.getAvailable())
                .name(request.getName())
...
//        templateDao.findAll(Example.of(example), page);
        List<com.geo.coupon.template.dao.entity.CouponTemplate> result = templateDao.findAll(Example.of(example));
    ...
    public Map<Long, CouponTemplateInfo> getTemplateInfoMap(Collection<Long> ids) {
        ...
        List<com.geo.coupon.template.dao.entity.CouponTemplate> templates = templateDao.findAllById(ids);
